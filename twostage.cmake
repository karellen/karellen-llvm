...
# LLDB is no longer built in-tree: it is built standalone, once per Python ABI,
# by the repo-owned lldb-multipython driver against this stage-2 LLVM/Clang.
...
# Feed the shared optimization/quality settings to the stage-2 configure via a
# "-C <cache>" arg (the clang bootstrap appends CLANG_BOOTSTRAP_CMAKE_ARGS to the
# stage-2 ExternalProject CMAKE_ARGS). The same file is consumed by the standalone
# LLDB builds (lldb-multipython), guaranteeing identical settings by construction.
# CMAKE_CURRENT_LIST_DIR resolves to this file's directory (mapped to /build).
set(CLANG_BOOTSTRAP_CMAKE_ARGS "-C${CMAKE_CURRENT_LIST_DIR}/stage2-common.cmake" CACHE STRING "")
...
# Relative-path / split-DWARF / LTO / build-type / flags moved to
# stage2-common.cmake (shared with the standalone LLDB builds) and reach stage 2
# via CLANG_BOOTSTRAP_CMAKE_ARGS above.
...
# LTO / terminfo / libedit / lld / libcxx moved to stage2-common.cmake.
...
# LLVM_ENABLE_DUMP, split-DWARF, build type and RelWithDebInfo flags moved to
# stage2-common.cmake (shared with the standalone LLDB builds).
